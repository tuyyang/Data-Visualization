async function drawBars() {
  ...
  // console.log(dateAccessor(dataset[0]))
  ...
  // console.log(dimensions.boundedRadius)
...
//   const angles = 0 * ((Math.PI * 2) / metrics.length) - Math.PI * 0.5
//   console.log(angles)
// console.log('x1', dimensions.boundedWidth / 2)
// console.log('x2', Math.cos(angles) * dimensions.boundedRadius + dimensions.boundedWidth / 2)
// console.log('y1', dimensions.boundedHeight / 2)
// console.log('y2', Math.sin(angles) * dimensions.boundedRadius + dimensions.boundedWidth / 2)
